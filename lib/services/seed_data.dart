...
class SeedData {
  ...
  static List<Delivery> deliveries() {
    ...
    return [
      Delivery(id: 'DL-001', farmerSupplierId: 'FS-001', date: now.subtract(const Duration(days: 0)), volumeLiters: 240, weightKg: 246, classification: 'Class A', status: 'classified'),
      Delivery(id: 'DL-002', farmerSupplierId: 'FS-002', date: now.subtract(const Duration(days: 0)), volumeLiters: 190, weightKg: 194, classification: null, status: 'pending'),
      Delivery(id: 'DL-003', farmerSupplierId: 'FS-004', date: now.subtract(const Duration(days: 1)), volumeLiters: 215, weightKg: 220, classification: 'Class B', status: 'classified'),
      Delivery(id: 'DL-004', farmerSupplierId: 'FS-006', date: now.subtract(const Duration(days: 1)), volumeLiters: 180, weightKg: 186, classification: 'Rejected', status: 'classified'),
      Delivery(id: 'DL-005', farmerSupplierId: 'FS-007', date: now.subtract(const Duration(days: 2)), volumeLiters: 260, weightKg: 266, classification: 'Class A', status: 'classified'),
      Delivery(id: 'DL-006', farmerSupplierId: 'FS-005', date: now.subtract(const Duration(days: 2)), volumeLiters: 205, weightKg: 211, classification: null, status: 'pending'),
      Delivery(id: 'DL-007', farmerSupplierId: 'FS-008', date: now.subtract(const Duration(days: 3)), volumeLiters: 172, weightKg: 176, classification: 'Class B', status: 'classified'),
      Delivery(id: 'DL-008', farmerSupplierId: 'FS-001', date: now.subtract(const Duration(days: 3)), volumeLiters: 229, weightKg: 233, classification: 'Class A', status: 'classified'),
      Delivery(id: 'DL-009', farmerSupplierId: 'FS-004', date: now.subtract(const Duration(days: 4)), volumeLiters: 199, weightKg: 204, classification: null, status: 'pending'),
      Delivery(id: 'DL-010', farmerSupplierId: 'FS-002', date: now.subtract(const Duration(days: 4)), volumeLiters: 188, weightKg: 194, classification: 'Class B', status: 'classified'),
      Delivery(id: 'DL-011', farmerSupplierId: 'FS-007', date: now.subtract(const Duration(days: 5)), volumeLiters: 250, weightKg: 255, classification: 'Class A', status: 'classified'),
      Delivery(id: 'DL-012', farmerSupplierId: 'FS-006', date: now.subtract(const Duration(days: 5)), volumeLiters: 166, weightKg: 170, classification: null, status: 'pending'),
      Delivery(id: 'DL-013', farmerSupplierId: 'FS-005', date: now.subtract(const Duration(days: 6)), volumeLiters: 221, weightKg: 226, classification: 'Class B', status: 'classified'),
      Delivery(id: 'DL-014', farmerSupplierId: 'FS-008', date: now.subtract(const Duration(days: 6)), volumeLiters: 210, weightKg: 215, classification: 'Class A', status: 'classified'),
      Delivery(id: 'DL-015', farmerSupplierId: 'FS-003', date: now.subtract(const Duration(days: 7)), volumeLiters: 134, weightKg: 138, classification: 'Rejected', status: 'classified'),
      Delivery(id: 'DL-016', farmerSupplierId: 'FS-002', date: now.subtract(const Duration(days: 8)), volumeLiters: 175, weightKg: 179, classification: null, status: 'pending'),
      Delivery(id: 'DL-017', farmerSupplierId: 'FS-001', date: now.subtract(const Duration(days: 9)), volumeLiters: 244, weightKg: 249, classification: 'Class A', status: 'classified'),
      Delivery(id: 'DL-018', farmerSupplierId: 'FS-004', date: now.subtract(const Duration(days: 10)), volumeLiters: 208, weightKg: 212, classification: 'Class B', status: 'classified'),
    ];
  }
